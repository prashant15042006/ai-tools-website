...
export default function ImageGenerator() {
  ...
  const generateImage = () => {
    ...
    img.onload = () => {
      ...
      setLoading(false);
      setHistory(prev =>
        [{ url, prompt: prompt.trim(), model, seed, id: Date.now() }, ...prev].slice(0, 20)
      );
      setActiveTab("view");
    ...
    img.onerror = () => {
      ...
      retryImg.onload = () => {
        ...
        setLoading(false);
        setHistory(prev =>
          [{ url: retryUrl, prompt: prompt.trim(), model, seed: retrySeed, id: Date.now() }, ...prev].slice(0, 20)
        );
        setActiveTab("view");
        showToast("Image generated! ✨");
      };
  ...
  // ── Regenerate with same prompt, new seed ───────────────
  const regenerate = () => {
      ...
      <div style={{ marginBottom: "28px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <p style={{ color: "#4ade80", fontSize: "14px", fontWeight: "600", margin: 0 }}>
            100% Free • No API Key • No Login Required • Powered by Pollinations AI
          </p>
        </div>
      </div>
        ...
        <div>
          ...
          <div style={{
            ...
            <div style={{ marginTop: "10px", fontSize: "12px", color: "var(--text-secondary)" }}>
              Ctrl + Enter to generate instantly
            </div>
          </div>
              ...
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ color: "var(--text-primary)", fontSize: "14px", lineHeight: "1.7" }}>
                    ...
                    {MODELS.find(m => m.id === (history[0]?.model || model))?.label}
                    </strong> model for this generation.
                    <br />
                  ...
                  <div style={{ marginTop: "12px", display: "flex", gap: "10px", flexWrap: "wrap" }}>
                    ...
                    <button onClick={regenerate} style={{
                      ...
                      <RefreshCw size={12} /> Different Style
                    </button>
                    <button onClick={() => handleDownload(imageUrl)} style={{
                      background: "rgba(168,85,247,0.12)", color: "#c084fc",
                      border: "1px solid rgba(168,85,247,0.25)",
